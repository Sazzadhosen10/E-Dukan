...
<div class="row">
    <!-- Total Sliders Card -->
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card stat-card h-100 py-2" style="border-left: 4px solid #e83e8c !important;">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="stat-label" style="color: #e83e8c;">Total Sliders</div>
                        <div class="stat-value">{{ $totalSliders ?? 0 }}</div>
                    </div>
                    <div class="col-auto">
